...
export const SECTION_DEFINITIONS: Record<string, SectionDefinition> = {
    ...
    healthcareProviderFullPage: {
        type: 'healthcareProviderFullPage',
        name: 'Healthcare Provider Full Page',
        description: 'Complete professional healthcare facility page - exactly like PHN providers',
        category: 'layout',
        icon: {
        ...
        fields: {
            ...
            // Services - boolean fields for each service type
            hasAssistedLiving: {
                type: 'boolean',
                required: false,
            ...
            admissionCoordinatorPhone: {
                type: 'text',
                required: false,
                label: 'Coordinator Direct Phone',
                placeholder: '(555) 123-4567'
            },
